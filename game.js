...
//player health console
console.log(playerHealth);

var startGame = function() {
  //reset player stats so they dont enter a new game with the stats from last game
  playerHealth = 100;
  playerAttack = 10;
  playerMoney = 10;
...
//endgame functions to show stats
var endGame = function() {
  ...
  if (playerHealth > 0) {
    ...
    window.alert("you have lost your robot and you suck.");
  }
